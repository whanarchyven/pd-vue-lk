<template>
  ...
  >
    <template v-slot:item="{ item }">
      <span v-if="columns[columnKey].class.dynamic" class="data-table-select-option" :class="columns[columnKey].class.name + item">
        {{ columns[columnKey].filter.optionsText ? columns[columnKey].filter.optionsText[item] : item }}
      </span>
